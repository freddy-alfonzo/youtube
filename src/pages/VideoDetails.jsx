...
function VideoDetails() {
  ...
  return (
    <>
      ...
      <div className={`pl-0  ${sidebarExtend ? "sm:pl-[180px]" : "sm:pl-[70px]"} pt-20 ml-4`}>
        <div className='w-[95%] max-w-[1020x] h-[280px] sm:h-[350px] md:h-[400px] lg:h-[560px] xl:h-[680px] container'>
        ...
        <div className='flex flex-col gap-y-4 mt-48 sm:mt-40'>
