    ...
    <>
      ...
      <div className={`pt-14 ml-4 pl-0  ${sidebarExtend ? "sm:pl-[180px]" : "sm:pl-[70px]"}`}>
        ...
        <div className='flex gap-x-5 items-center my-5'>
          <img className='rounded-[40px] w-12 h-12 md:w-16 md:h-16' src={channelDetails?.snippet?.thumbnails?.medium?.url ? channelDetails?.snippet?.thumbnails?.medium?.url : noImg} />
        ...
        <div>
          ...
          <div className='mt-3 flex justify-center flex-wrap gap-x-5 gap-y-3'>
            {
